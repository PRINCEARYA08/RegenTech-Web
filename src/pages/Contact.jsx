...
const Contact = () => {
  ...
  return (
  <div className="w-full h-full min-h-screen relative flex flex-col gap-10 bg-[#eceaff] text-black">
      <div className="flex w-full flex-col min-h-[100vh] items-center gap-10 lg:items-start justify-center px-8 pt-28 ">
        <div className="text-center w-full flex justify-center flex-col items-center gap-2">
          ...
          />
          <p style={{ color: dark === true ? "#ccc" : "#410bbdff" }}>Choose your preferred way to get help from our support team:</p>
        </div>
  <div className="relative w-full h-full flex items-center justify-center gap-8 flex-col lg:flex-row px-2 lg:px-10">
          {/* Call Us */}
          <div className="min-w-full lg:min-w-[30vw] px-6 py-6 min-h-[20vh] flex flex-col justify-start gap-2 bg-white rounded-2xl shadow-lg border-none">
            <div className="flex items-center gap-4">
              <div
                className="p-4 border-[#bdb4fa] hover:bg-[#eceaff] duration-300 hover:text-black border-[1px] w-fit rounded-full bg-[#eceaff] cursor-pointer"
                onClick={() => navigate("/regentech/callus")}
                title="Go to Call Us page"
              >
                <span><IoIosCall /></span>
              </div>
              <div className="w-fit">
            ...
            <div className="flex items-center justify-center w-full pl-16 ">
              <p style={{ color: '#444', width: "fit-content", fontSize: "15px" }}>Need immediate help? Call us now at +91 9243611149</p>
            </div>
          ...
          <div className="min-w-full lg:min-w-[30vw] px-6 py-6 min-h-[20vh] flex flex-col justify-start gap-2 bg-white rounded-2xl shadow-lg border-none">
            <div className="flex items-center gap-4">
              <div
                className="p-4 border-[#bdb4fa] hover:bg-[#eceaff] duration-300 hover:text-black border-[1px] w-fit rounded-full bg-[#eceaff] cursor-pointer"
                onClick={() => navigate("/regentech/emailus")}
                title="Go to Email Us page"
              >
            ...
            <div className="flex items-center justify-center w-full pl-16 ">
              <p style={{ color: '#444', width: "fit-content", fontSize: "15px" }}>Prefer email? Reach out to us at regentechinstitute@gmail.com</p>
            </div>
          ...
          <div className="min-w-full lg:min-w-[30vw] px-6 py-6 min-h-[20vh] flex flex-col justify-start gap-2 bg-white rounded-2xl shadow-lg border-none">
            <div className="flex items-center gap-4">
              <div
                className="p-4 border-[#bdb4fa] hover:bg-[#eceaff] duration-300 hover:text-black border-[1px] w-fit rounded-full bg-[#eceaff] cursor-pointer"
                onClick={() => navigate("/regentech/contactus")}
                title="Go to Chat with Us page"
              >
            ...
            <div className="flex items-center justify-center w-full pl-16 ">
              <p style={{ color: '#444', width: "fit-content", fontSize: "15px" }}>Have questions? Start a live chat with one of our agents right now.</p>
            </div>
  ...
  <div className="w-full min-h-[10vh] md:h-[65vh] lg:h-[60vh] mx-auto flex items-start justify-center flex-col lg:px-40 md:px-20 px-10">
          <div className="text-center w-full flex justify-center pb-10 flex-col items-center gap-2">
            <BlurText
              ...
              className="text-xl md:text-2xl lg:text-4xl text-shadow-lg font-[Boldonse] w-fit"
            />
            <p style={{color: '#444'}}>Choose your preferred way to get help from our support team:</p>
          </div>
      ...
      <div className=" px-4 pb-20 pt-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex justify-center items-center">
            <img
              src={dark === true ? logoBlackMood : logoLightMood}
              alt="Regentech"
