      ...
      <div className="flex w-full flex-col min-h-[100vh] items-center gap-10 lg:items-start justify-center px-8 pt-28 ">
         <div className="text-center w-full flex justify-center  flex-col items-center gap-2">
          ...
          <div className="relative w-full h-full flex items-center justify-center gap-5 flex-col lg:flex-row px-2 lg:px-10">
            ...
            <div 
            key={index} 
            className="min-w-full lg:min-w-[30vw] px-3 py-3 min-h-[20vh] flex flex-col justify-start gap-2 border-[1px] border-zinc-100 dark:border-black rounded-t-4xl">
              ...
              <div className="flex items-center justify-center w-full pl-16 ">
                <p style={{color: dark === false ? "#ccc" : "#000", width: "fit-content", fontSize: "15px"}}>{det.details}</p>
              </div>
              <a href={det.con} className="w-full inline-flex items-center justify-center py-5">
                <EnrollButton title={det.button} icon={det.icon} />
              </a>
            </div>
            ))}
          </div>
