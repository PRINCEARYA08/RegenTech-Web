...
const Whychooseus = () => {
  ...
  <section className="w-full min-h-[350px] flex flex-col md:flex-row items-center justify-center px-10 py-10 gap-10">
        ...
        <div className="flex-1 flex items-center justify-center">
          <img src="/images/courses/auto.webp" alt="Industry Ready Courses" className="w-[400px] h-[250px] object-contain rounded-lg" />
        </div>
      </section>
  ...
  <section className="w-full min-h-[350px] flex flex-col md:flex-row items-center justify-center px-10 py-10 gap-10">
        <div className="flex-1 flex items-center justify-center">
          <img src="../../../public/images/service/Industry-Ready Courses.png" alt="Mentorship" className="w-[400px] h-[250px] object-contain rounded-lg" />
        </div>
        <div className="flex-1 flex flex-col justify-center gap-4">
  ...
  <section className="w-full min-h-[350px] flex flex-col md:flex-row items-center justify-center px-10 py-10 gap-10">
        <div className="flex-1 flex items-center justify-center">
          <img src="/images/gellery/photo1.jpg" alt="Connect & Collaborate" className="w-[400px] h-[250px] object-contain rounded-lg" />
        </div>
        <div className="flex-1 flex flex-col justify-center gap-4">
  ...
  <section className="w-full min-h-[350px] flex flex-col md:flex-row items-center justify-center px-10 py-10 gap-10">
        <div className="flex-1 flex items-center justify-center">
          <img src="/images/gellery/photo2.jpg" alt="Global Opportunities" className="w-[400px] h-[250px] object-contain rounded-lg" />
        </div>
        <div className="flex-1 flex flex-col justify-center gap-4">
